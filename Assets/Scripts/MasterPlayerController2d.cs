...
class MasterPlayerController2d : MonoBehaviour
{
	...
	/// </summary>
	public PlayerPlatformController2d PlatformController
	{
		get; private set;
	}
	...
	/// </summary>
	public PlayerLadderController2d LadderController
	{
		get; private set;
	}
	...
	/// <summary>
	/// Gets or sets the TriggerTest on a child GameObject.
	/// </summary>
	public TriggerTest LadderGrabTest
	{
		get; private set;
	}
	...
	/// Gets or sets the TriggerTest on a child GameObject.
	/// </summary>
	public TriggerTest LadderDownTest
	{
		get; private set;
	}
	...
	/// <summary>
	/// Sets the player to the platfrom state.
	/// </summary>
	...
	/// <summary>
	/// Sets the player to face a specfic direction.
	/// </summary>
